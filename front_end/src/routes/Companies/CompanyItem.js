...
export default function CompanyItem({ data }) {
	return (
		<li key={data._id} className="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow">
			<div className="flex flex-1 flex-col p-8">
				<img className="mx-auto h-20 w-20 flex-shrink-0 rounded-full" src={data.logo} alt="" />
